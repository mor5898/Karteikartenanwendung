...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" href="../css/karteikarteAbfrage.css">
		<script src="../js/ViewStudent_KarteikarteAbfrage.js"></script>
	...
	<body>
		...
		<div>
			...
			<fieldset>
						...
						<div>
							<button type="button" id="begruendungButton">Begr&uuml;ndung anzeigen</button>
						</div>
						<div>
			...
			<div class="buttonContainer">
				<button name="beenden" type="submit" id="beenden" formaction="../View_StudentHome.jsp">Beenden</button>
