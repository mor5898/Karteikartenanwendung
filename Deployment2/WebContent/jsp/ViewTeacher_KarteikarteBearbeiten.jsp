...
<body class="body">
	...
	<form method="post" action="../ViewTeacher_KarteikarteBearbeitenPersistServlet" enctype="multipart/form-data">
		...
		<input type="text" id="titel" name="titel" class="input" value="${karteikarte.titel}" required maxlength="50">
		<label for="fragentext">Frage:</label>
		<input type="text" id="fragentext" name="fragentext" class="input" value="${karteikarte.fragentext}" required maxlength="250">
		...
		<div class="div2">
			...
			<input type="text" id="antwortA" name="antwortA" class="input" value="${karteikarte.antwortA}" required maxlength="250">
			<label for="antwortB">Antwort B:</label>
			<input type="text" id="antwortB" name="antwortB" class="input" value="${karteikarte.antwortB}" required maxlength="250">
			<label for="antwortC">Antwort C:</label>
			<input type="text" id="antwortC" name="antwortC" class="input" value="${karteikarte.antwortC}" required maxlength="250">
			<label for="antwortD">Antwort D:</label>
			<input type="text" id="antwortD" name="antwortD" class="input" value="${karteikarte.antwortD}" required maxlength="250">
		</div>
		...
		<input type="text" id="begruendungstext" name="begruendungstext" class="input" value="${karteikarte.begruendung}" required maxlength="500">
